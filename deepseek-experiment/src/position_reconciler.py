...
class PositionReconciler:
    ...
    def reconcile_positions(
        self, bot_positions: Dict, current_price: float = None
        ...
        try:
            ...
            discrepancies = self._compare_positions(
                bot_positions=bot_positions, exchange_positions=exchange_positions, current_price=current_price
            )
    ...
    def _compare_positions(
        self, bot_positions: Dict, exchange_positions: Dict, current_price: float = None
    ...
    def get_reconciliation_stats(self) -> Dict:
        ...
        return {
            ...
            "last_reconciliation_time": (
                self.last_reconciliation_time.isoformat() if self.last_reconciliation_time else None
            ),
        }
