...
from config.config import (
    ...
    # Exchange
    EXCHANGE, SYMBOL, USE_TESTNET,
    # Trading
    TRADING_MODE, INITIAL_BALANCE, MAX_POSITION_SIZE,
    MAX_LEVERAGE, DEFAULT_LEVERAGE, TRADING_FEE_PERCENT,
    MAX_RISK_PER_TRADE, STOP_LOSS_PERCENT, TAKE_PROFIT_PERCENT,
    MAX_ACTIVE_POSITIONS, MIN_CONFIDENCE_THRESHOLD,
    FEE_IMPACT_WARNING_THRESHOLD, RUN_INTERVAL_SECONDS,
    # Position Management
    ENABLE_POSITION_MONITORING, PORTFOLIO_PROFIT_TARGET_PCT,
    ENABLE_TRAILING_STOP_LOSS, TRAILING_STOP_DISTANCE_PCT,
    TRAILING_STOP_ACTIVATION_PCT, ENABLE_PARTIAL_PROFIT_TAKING,
    PARTIAL_PROFIT_PERCENT, PARTIAL_PROFIT_TARGET_PCT,
    # Logging
    LOG_LEVEL
)
...
def _apply_env_overrides(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if os.getenv("ENABLE_POSITION_MONITORING"):
        config["position_management"]["enable_position_monitoring"] = os.getenv("ENABLE_POSITION_MONITORING", "true").lower() == "true"
    ...
    if os.getenv("ENABLE_TRAILING_STOP_LOSS"):
        config["position_management"]["enable_trailing_stop_loss"] = os.getenv("ENABLE_TRAILING_STOP_LOSS", "true").lower() == "true"
    ...
    if os.getenv("ENABLE_PARTIAL_PROFIT_TAKING"):
        config["position_management"]["enable_partial_profit_taking"] = os.getenv("ENABLE_PARTIAL_PROFIT_TAKING", "true").lower() == "true"
