...
class TestTradingEngine(unittest.TestCase):
    ...
    def test_execute_buy(self):
        ...
        # Balance = 1000 - 100 - (100 * 0.05%) = 1000 - 100 - 0.05 = 899.95
        # Account for trading fee (0.05% of 100 USDT = 0.05)
        expected_balance = 1000.0 - 100.0 - (100.0 * 0.0005)
        self.assertAlmostEqual(self.engine.balance, expected_balance, places=2)
